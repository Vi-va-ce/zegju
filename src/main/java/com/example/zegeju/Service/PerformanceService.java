...
//                   return questionCatagoryobj.equals("command_of_evidence");
    ...
    private void updateMapData(String email_userId, HashMap<String, Object> userResponse,HashMap<String, Object> SectionIdProvidingResponse ) throws ExecutionException, InterruptedException {
       String test_id= (String) userResponse.get("test_id");
       String section_id= sectionsPerformanceService.returnSectionId(SectionIdProvidingResponse);
       if (test_id.contains("agnostic")){
            mapService.update(email_userId,section_id,test_id);
       }
       else if (test_id.contains("inal")){
           mapService.update(email_userId,section_id,test_id);
        }
       else if (test_id.contains("actice")){
            mapService.updatePractice(email_userId,section_id,test_id);
       }
    }


    public Object generatePracticeTestResult(String email_userId,HashMap<String,Object> userResponses) throws ExecutionException, InterruptedException {
        /* Generate  dashboard DATA*/
//        saveDashboardData(userResponse);
...
//                generateSectionTestScore(section_Scores,email_userId,scoring);
//                responseText.put("Status","Response Submitted");
                return generateDashboardDataForPracticeTestResult(dashboardData,email_userId);
